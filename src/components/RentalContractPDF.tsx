          ...
          <View style={{ flexDirection: "row", gap: 20 }}>
            ...
            <View style={{ flex: 1 }}>
              <View style={S.financialRow}>
                ...
                <Text style={S.financialValue}>€{data.dailyRate.toFixed(2)}</Text>
              </View>
              <View style={S.financialRow}>
                <Text style={S.financialLabel}>Depozit:</Text>
                <Text style={S.financialValue}>€{data.depositAmount.toFixed(2)}</Text>
              </View>
            </View>
          </View>
          <View style={S.totalRow}>
            <Text style={S.totalLabel}>UKUPAN IZNOS NAJMA:</Text>
            <Text style={S.totalValue}>€{data.totalAmount.toFixed(2)}</Text>
          </View>
        </View>
