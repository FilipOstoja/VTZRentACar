  ...
  return (
    <div className="bg-blue-50/40 border-b border-blue-100 px-4 py-3">
      <div className="flex items-center gap-2 mb-2">
        ...
        <span className="text-[11px] font-semibold text-brand-500 uppercase tracking-wider">Brzi unos troška</span>
      </div>
      <div className="flex flex-wrap items-end gap-2">
        <div className="flex-1 min-w-[160px]">
          <select
            ...
            className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
          >
        ...
        <select
          ...
          className="bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
        >
          {TYPES.map((t) => (
        ...
        <input
          ...
          className="w-24 bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-sm text-slate-800 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
        />
        <input
          type="date"
          value={date}
        ...
        <input
          ...
          onKeyDown={(e) => e.key === "Enter" && save()}
          className="flex-1 min-w-[140px] bg-white border border-slate-200 rounded-lg px-2.5 py-2 text-sm text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-brand-500/20 focus:border-brand-500"
        />
